...
public class CountDown extends JFrame {
   ...
   public CountDown() {
      ...
      String names[] = { "0.gif", "1.gif", "2.gif", "3.gif", "4.gif", "5.gif", "6.gif", "7.gif", "8.gif", "9.gif" };
   ...
   private class ButtonHandler implements ActionListener {
      ...
      public void actionPerformed(ActionEvent event) {
         JOptionPane.showMessageDialog(CountDown.this, "You pressed: " + event.getActionCommand());
      }
   ...
   private class TimerHandler implements ActionListener {
      ...
      // handle button event
      public void actionPerformed(ActionEvent event) {
         JOptionPane.showMessageDialog(CountDown.this, "Timer Expired");
