...
public class Pilot {
   ...
   @Override
   public int hashCode() {
      return new HashCodeBuilder().append(multisectionId).append(points).append(name).append(ship).append(hull)
            .append(shields).append(upgrades).append(vendor).toHashCode();
   }
   ...
   public boolean equals(Object other) {
      ...
      return new EqualsBuilder().append(multisectionId, rhs.multisectionId).append(points, rhs.points)
            .append(name, rhs.name).append(ship, rhs.ship).append(hull, rhs.hull).append(shields, rhs.shields)
            .append(upgrades, rhs.upgrades).append(vendor, rhs.vendor).isEquals();
   }
